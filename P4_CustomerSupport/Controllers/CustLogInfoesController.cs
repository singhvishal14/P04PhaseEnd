...
namespace P4_CustomerSupport.Controllers
{
    public class CustLogInfoesController : Controller
    {
        private readonly BankAppContext _context;

        public CustLogInfoesController(BankAppContext context)
        {
            _context = context;
        }
        ...
        {
            var bankAppContext = _context.CustLogInfos.Include(c => c.User);
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'BankAppContext.CustLogInfos'  is null.");
            }
            var custLogInfo = await _context.CustLogInfos.FindAsync(id);
            if (custLogInfo != null)
            {
